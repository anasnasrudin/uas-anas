    ...
    <main class="d-flex vh-100 w-100">
        <div id="sidebar" class="px-3" style="background-color: #d6f0ff; height: 100vh;">
            <div class="d-flex flex-column align-items-center justify-content-center h-100 gap-3">
                <h3 class="fw-bold text-black" style="margin-bottom: 50px">GUDANG</h3>
                <img src="/assets/img/gudang.png" alt="Kasir Image" width="120" style="margin-bottom: 50px">
                <h3 class="fw-bold text-center mb-0">KELOLA<br>BARANG</h3>
